/***********************************************************************************************************************
  File: V1494399456__exam_qa_view_udpates.sql

  Desc: Alter view to use make opportunityrestart value match what is stored in the legacy database
...
CREATE OR REPLACE VIEW qa_session_testeeresponse AS
  SELECT
    ...
    (exam.attempts -1) AS opportunityrestart,
